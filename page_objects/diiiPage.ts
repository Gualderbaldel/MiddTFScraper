...
export class DIIIPAGE {
    ...
    async goto(outdoor: boolean) {
        if(outdoor) this.page.goto("https://tf.tfrrs.org/list_data/5604?other_lists=https%3A%2F%2Ftf.tfrrs.org%2Flists%2F5604%2F2026_NCAA_Division_III_Outdoor_Qualifying_FINAL&limit=500&gender=m")
        else this.page.goto("https://tf.tfrrs.org/list_data/5354?other_lists=https%3A%2F%2Ftf.tfrrs.org%2Flists%2F5354%2F2025_2026_NCAA_Division_III_Indoor_List_FINAL&limit=500&event_type=&year=&gender=m")
