...
export class MiddPage {
    ...
    async goto(outdoor: boolean) {
        if (outdoor) {
            await this.page.goto("https://www.tfrrs.org/teams/tf/VT_college_m_Middlebury.html?config_hnd=434");
        } else {
            await this.page.goto("https://www.tfrrs.org/teams/tf/VT_college_m_Middlebury.html?config_hnd=416");
        }
    }
